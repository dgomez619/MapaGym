...
// FIX 1: Update Interface to match MongoDB (_id instead of id)
interface User {
  _id: string; 
  name: string;
  email: string;
      ...
      >
        ...
        <div className="p-6 pb-0 relative">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              {/* FIX 2: Use _id and add a safety check (|| '') before slicing */}
              <p className="text-zinc-500 text-xs font-mono mt-1">
                ID: {(profile?._id || '').slice(-6).toUpperCase()} // EST. {new Date(profile?.createdAt || '').getFullYear()}
              </p>
            </div>
          </div>
        ...
        <div className="p-6 grid grid-cols-3 gap-3">
          <div className="bg-zinc-900/50 p-3 rounded-xl border border-zinc-800 flex flex-col items-center justify-center gap-1 group hover:border-volt-green/30 transition-colors">
             ...
             {/* FIX 3: Added optional chaining here just in case */}
